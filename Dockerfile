# CK.Lib.Js v1.3.3 OCI Bundle — Static Artifact (root layout, binary codec + display roles)
# v1.3.3: pipeline iteration #3 — package Actions access granted; expect GHA push to succeed
