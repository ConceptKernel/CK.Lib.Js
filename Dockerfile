# CK.Lib.Js v1.3.4 OCI Bundle — Static Artifact (root layout, binary codec + display roles)
# v1.3.4: pipeline iteration #4 — GHA build+push works; this iteration adds in-pipeline gh release create
